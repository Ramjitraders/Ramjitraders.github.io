...
(function () {
  ...
  var D = {
    ...
    en: {
      ...
      'fm.note': 'Submitting opens your email app with a pre-filled message to <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — no account needed.',
      'fm.success': '✓ Your email app should now open with your inquiry. If it didn’t, write to us directly at <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — we reply within 24 hours.',
    ...
    de: {
      ...
      'fm.note': 'Beim Absenden öffnet sich Ihr E-Mail-Programm mit einer vorgefertigten Nachricht an <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — kein Konto erforderlich.',
      'fm.success': '✓ Ihr E-Mail-Programm sollte sich jetzt mit Ihrer Anfrage öffnen. Falls nicht, schreiben Sie uns direkt an <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — wir antworten innerhalb von 24 Stunden.',
