...
(function () {
  ...
  var D = {
    ...
    en: {
      ...
      'hero.sub': 'Bitumen & EPDM washers from India’s leading manufacturers — delivered to Europe by a partner who spent two years on the ground in Germany learning how European business works.',
      'hero.cta2': 'Watch the Journey ↓',
      'chip.bitumen': 'Bitumen Washers', 'chip.epdm': 'EPDM Washers', 'chip.partner': 'Global Sourcing Partner',
      'ui.scroll': 'SCROLL',
      ...
      'tick.6': 'India → Europe', 'tick.7': '25–30 Yr Service Life',
      ...
      'p.title': 'Two Products.<br><em class="gold-i">Perfected.</em>',
      ...
      'a.p1': 'Ram ji Traders is a global sourcing partner based in India. We work with the country’s established washer manufacturers — producers with proven market strength at home — and connect their products with buyers worldwide.',
      'a.p2': 'Our edge is cultural: after two years living and doing business in Germany, we work the way European procurement expects — clear specifications, firm quotations, punctual dispatch and complete, trustworthy documentation.',
      'a.dt1': 'Products', 'a.dd1': 'Bitumen & EPDM Washers',
      ...
      'c.btn': 'Contact Us',
      'f.brand': 'Global sourcing partner for bitumen and EPDM washers — connecting India’s leading manufacturers with buyers across Europe and beyond.',
      'f.contact': 'Contact', 'f.explore': 'Explore', 'f.base': 'India · Export Worldwide',
      'f.rights': 'All rights reserved.', 'f.madein': 'Bitumen & EPDM Washers · Made in India',
      /* contact page */
      'ph.kicker': 'Contact',
      'ph.title': 'Let’s Talk <em class="gold-i">Washers.</em>',
      ...
      'fm.opt3': 'Both — Bitumen & EPDM', 'fm.opt4': 'Custom Specification',
      ...
      'fm.note': 'Submitting sends your inquiry straight to our inbox <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — no email app or account needed.',
      'fm.success': '✓ Thank you — your inquiry has been sent to our team. We reply within 24 hours. Prefer direct email? <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a>',
      'fm.err': '⚠️ Auto-send failed (network issue). Please email us directly at <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — we reply within 24 hours.',
    ...
    de: {
      ...
      'hero.sub': 'Bitumen- und EPDM-Scheiben von Indiens führenden Herstellern — geliefert nach Europa von einem Partner, der zwei Jahre vor Ort in Deutschland die europäische Geschäftskultur kennengelernt hat.',
      'hero.cta2': 'Reise ansehen ↓',
      'chip.bitumen': 'Bitumenscheiben', 'chip.epdm': 'EPDM-Scheiben', 'chip.partner': 'Globaler Sourcing-Partner',
      'ui.scroll': 'SCROLLEN',
      ...
      'tick.6': 'Indien → Europa', 'tick.7': '25–30 Jahre Lebensdauer',
      ...
      'p.title': 'Zwei Produkte.<br><em class="gold-i">Perfektioniert.</em>',
      ...
      'a.p1': 'Ram ji Traders ist ein globaler Sourcing-Partner mit Sitz in Indien. Wir arbeiten mit den etablierten Dichtscheiben-Herstellern des Landes — Produzenten mit bewährter Marktstärke im Inland — und verbinden ihre Produkte mit Käufern weltweit.',
      'a.p2': 'Unser Vorteil ist kulturell: Nach zwei Jahren Leben und Arbeiten in Deutschland arbeiten wir so, wie es europäische Einkäufer erwarten — klare Spezifikationen, verbindliche Angebote, pünktlicher Versand und vollständige, verlässliche Dokumentation.',
      'a.dt1': 'Produkte', 'a.dd1': 'Bitumen- & EPDM-Scheiben',
      ...
      'c.btn': 'Kontakt',
      'f.brand': 'Globaler Sourcing-Partner für Bitumen- und EPDM-Scheiben — wir verbinden Indiens führende Hersteller mit Käufern in ganz Europa und darüber hinaus.',
      'f.contact': 'Kontakt', 'f.explore': 'Entdecken', 'f.base': 'Indien · Export weltweit',
      'f.rights': 'Alle Rechte vorbehalten.', 'f.madein': 'Bitumen- & EPDM-Scheiben · Made in India',
      /* contact page */
      'ph.kicker': 'Kontakt',
      'ph.title': 'Sprechen wir über <em class="gold-i">Scheiben.</em>',
      ...
      'fm.opt3': 'Beides — Bitumen & EPDM', 'fm.opt4': 'Kundenspezifisch',
      ...
      'fm.note': 'Absenden sendet Ihre Anfrage direkt an unser Postfach <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — kein E-Mail-Programm oder Konto erforderlich.',
      'fm.success': '✓ Vielen Dank — Ihre Anfrage wurde an unser Team gesendet. Wir antworten innerhalb von 24 Stunden. Lieber direkt per E-Mail? <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a>',
      'fm.err': '⚠️ Senden fehlgeschlagen (Netzwerkproblem). Bitte schreiben Sie uns direkt an <a href="mailto:export.ramjitraders@gmail.com">export.ramjitraders@gmail.com</a> — wir antworten innerhalb von 24 Stunden.',
  ...
  var TITLES = {
    en: {
      home: 'Ram ji Traders — Global Sourcing Partner for Industrial Washers | India → Europe',
      contact: 'Contact — Ram ji Traders | Request a Quote'
    },
    de: {
      home: 'Ram ji Traders — Globaler Sourcing-Partner für industrielle Dichtscheiben | Indien → Europa',
