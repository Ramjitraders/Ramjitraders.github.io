...
(function () {
  ...
  var D = {
    ...
    en: {
      ...
      'chip.copper': 'Seamless Copper Pipes (EN 1057)',
      ...
      'pe.thumbcap': 'Bonded washer close-up · On self-drilling roofing screws',
            'chip.copper': 'Seamless Copper Pipes (EN 1057)',
      'pc.tag': 'DIN EN 1057 · DVGW GW 392 · Half-Hard R250',
      'pc.h3': 'Seamless Copper Plumbing & Heating Pipes',
      'pc.desc': 'High-purity seamless phosphorus-deoxidized copper tubes (Cu-DHP / CW024A, min. 99.90% pure copper) manufactured strictly to DIN EN 1057 and DVGW GW 392 European standards for drinking water and hydronic heating systems. 100% calibrated for German press-fitting systems.',
      'pc.s1': 'Material: Cu-DHP (CW024A / 2.0090, TOC < 0.06 mg C/dm² per EN 723)',
      'pc.s2': 'Tempers: Half-Hard R250 (5.0m Straight Lengths) & R220 Soft Coils',
      'pc.s3': 'Dimensions: OD 10 mm to 108 mm (Standard 15, 18, 22, 28, 35, 42, 54 mm)',
      'pc.s4': 'Quality Testing: 100% Non-Destructive Eddy Current Leak Tested (EN 1971)',
      'pc.s5': 'Compatibility: 100% certified for Viega Profipress & Geberit Mapress systems',
      'pc.s6': 'Certification: EN 10204 Type 3.1 Mill Test Certificate & Chamber of Commerce COO',
      'pc.link': 'Request Copper Pipe Quote →',
      'opt.copper': 'Seamless Copper Pipes (DIN EN 1057 / DVGW)',
